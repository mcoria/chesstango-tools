...
public class EpdSearchBottomMoveCounterTest {
    ...
    public void test_WAC003() {
        ...
        assertEquals(40, FENParser.loadGame(epd.getFenWithoutClocks()+ " 0 1").getPossibleMoves().size());
    ...
    public void test_WAC008() {
        ...
        epdSearchResult = epdSearch.run(buildSearchMove(new EvaluatorImp04()), epd);
        assertEquals(43, FENParser.loadGame(epd.getFenWithoutClocks()+ " 0 1").getPossibleMoves().size());
    ...
    public void test_WAC012() {
        ...
        epdSearchResult = epdSearch.run(buildSearchMove(new EvaluatorImp04()), epd);
        assertEquals(26, FENParser.loadGame(epd.getFenWithoutClocks()+ " 0 1").getPossibleMoves().size());
    ...
    public void test_WAC137() {
        ...
        epdSearchResult = epdSearch.run(buildSearchMove(new EvaluatorImp04()), epd);
        assertEquals(56, FENParser.loadGame(epd.getFenWithoutClocks()+ " 0 1").getPossibleMoves().size());
    ...
    public void test_WAC072() {
        ...
        epdSearchResult = epdSearch.run(buildSearchMove(new EvaluatorImp04()), epd);
        assertEquals(36, FENParser.loadGame(epd.getFenWithoutClocks()+ " 0 1").getPossibleMoves().size());
    ...
    public void test_WAC111() {
        ...
        epdSearchResult = epdSearch.run(buildSearchMove(new EvaluatorImp04()), epd);
        assertEquals(27, FENParser.loadGame(epd.getFenWithoutClocks()+ " 0 1").getPossibleMoves().size());
    ...
    public void test_WAC283() {
        ...
        epdSearchResult = epdSearch.run(buildSearchMove(new EvaluatorImp04()), epd);
        assertEquals(34, FENParser.loadGame(epd.getFenWithoutClocks()+ " 0 1").getPossibleMoves().size());
    ...
    public void test_BK04() {
        ...
        epdSearchResult = epdSearch.run(buildSearchMove(new EvaluatorImp04()), epd);
        assertEquals(38, FENParser.loadGame(epd.getFenWithoutClocks()+ " 0 1").getPossibleMoves().size());
    ...
    public void test_BK05() {
        ...
        epdSearchResult = epdSearch.run(buildSearchMove(new EvaluatorImp04()), epd);
        assertEquals(51, FENParser.loadGame(epd.getFenWithoutClocks()+ " 0 1").getPossibleMoves().size());
    ...
    public void test_BK06() {
        ...
        epdSearchResult = epdSearch.run(buildSearchMove(new EvaluatorImp04()), epd);
        assertEquals(24, FENParser.loadGame(epd.getFenWithoutClocks()+ " 0 1").getPossibleMoves().size());
    ...
    public void test_BK23() {
        ...
        epdSearchResult = epdSearch.run(buildSearchMove(new EvaluatorImp04()), epd);
        assertEquals(35, FENParser.loadGame(epd.getFenWithoutClocks()+ " 0 1").getPossibleMoves().size());
    ...
    public void test_40H_10390() {
        ...
        epdSearchResult = epdSearch.run(buildSearchMove(new EvaluatorImp04()), epd);
        assertEquals(21, FENParser.loadGame(epd.getFenWithoutClocks()+ " 0 1").getPossibleMoves().size());
    ...
    public void test_40H_9482() {
        ...
        epdSearchResult = epdSearch.run(buildSearchMove(new EvaluatorImp04()), epd);
        assertEquals(32, FENParser.loadGame(epd.getFenWithoutClocks()+ " 0 1").getPossibleMoves().size());
    ...
    public void test_40H_079() {
        ...
        epdSearchResult = epdSearch.run(buildSearchMove(new EvaluatorImp04()), epd);
        assertEquals(44, FENParser.loadGame(epd.getFenWithoutClocks()+ " 0 1").getPossibleMoves().size());
    ...
    public void test_40H_2462() {
        ...
        epdSearchResult = epdSearch.run(buildSearchMove(new EvaluatorImp04()), epd);
        assertEquals(46, FENParser.loadGame(epd.getFenWithoutClocks()+ " 0 1").getPossibleMoves().size());
    ...
    public void test_40H_022() {
        ...
        epdSearchResult = epdSearch.run(buildSearchMove(new EvaluatorImp04()), epd);
        assertEquals(52, FENParser.loadGame(epd.getFenWithoutClocks()+ " 0 1").getPossibleMoves().size());
    ...
    public void test_40H_10255() {
        ...
        epdSearchResult = epdSearch.run(buildSearchMove(new EvaluatorImp04()), epd);
        assertEquals(54, FENParser.loadGame(epd.getFenWithoutClocks()+ " 0 1").getPossibleMoves().size());
    ...
    public void test_40H_1027() {
        ...
        epdSearchResult = epdSearch.run(buildSearchMove(new EvaluatorImp04()), epd);
        assertEquals(16, FENParser.loadGame(epd.getFenWithoutClocks()+ " 0 1").getPossibleMoves().size());
    ...
    public void test_40H_3243() {
        ...
        epdSearchResult = epdSearch.run(buildSearchMove(new EvaluatorImp04()), epd);
        assertEquals(47, FENParser.loadGame(epd.getFenWithoutClocks()+ " 0 1").getPossibleMoves().size());
    ...
    public void test_sbd_058() {
        ...
        epdSearchResult = epdSearch.run(buildSearchMove(new EvaluatorImp04()), epd);
        assertEquals(30, FENParser.loadGame(epd.getFenWithoutClocks()+ " 0 1").getPossibleMoves().size());
