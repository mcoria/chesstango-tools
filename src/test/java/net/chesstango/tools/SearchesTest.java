...
public class SearchesTest {
    ...
    public void testSearch_01() {
        Game game = Game.fromFEN("r4rk1/p1qbp1b1/2p3pp/2Pn1p2/1pQ5/5B2/PPP1NPPP/R1B2RK1 w - - 1 22");
    ...
    public void testSearch_02() {
        Game game = Game.fromFEN("1k2r3/1pp5/4B3/1P3Q2/3q1Pp1/3n2Pp/3p3P/5R1K b - - 0 1");
    ...
    public void testSearch_03() {
        Game game = Game.fromFEN("8/p7/2R5/4k3/8/Pp1b3P/1r3PP1/6K1 w - - 2 43");
    ...
    public void testSearch_04() {
        Game game = Game.fromFEN("4R3/6pk/1p4Bp/5p2/p5P1/2BP3P/5P2/6K1 b - - 0 39");
    ...
    public void testSearch_06() {
        Game game = Game.fromFEN("R7/P4k2/8/8/8/8/r7/6K1 w - - 0 1");
    ...
    public void testSearch_09() {
        Game game = Game.fromFEN("rnb2rk1/pp3ppp/4pn2/2q5/1Q2P3/P1P2P2/3B2PP/R3KBNR b KQ - 4 12");
    ...
    public void testSearch_11() {
        Game game = Game.fromFEN("1r2r1k1/pp3p1p/3pb1pB/4b3/P2pQ3/1PqP2P1/2P2RBP/3R2K1 b - - 2 23");
    ...
    public void testSearch_12() {
        Game game = Game.fromFEN("1RRbr3/3pkp2/2b1p1p1/2P1P3/5PP1/P6P/1KP5/5B2 w - - 17 49");
